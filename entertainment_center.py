...
def start():
    """Start the Entertainment Center webpage"""
    movies = [
        media.Movie(
            'The Great Gatsby',
        ...
        media.Movie(
            ...
            'A biopic depicting the early years of legendary director and'
            ' aviator Howard Hughes\' career from the late 1920s to the'
            ' mid-1940s.'
        ),
        media.Movie(
    ...
    # Call open_movies_page to generate a webpage with gallery of movies based
    # on movies list created above
